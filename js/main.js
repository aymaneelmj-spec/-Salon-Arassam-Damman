(function () {
  ...
  (function mobileScissors() {
    ...
    var colors = ['#E0182D','#F4C430','#FFD966','#FF3B4E','#E0182D','#F4C430'];
  ...
  var chatFlow = {
    barber: {
      ...
      services: [
        ...
        { ar: 'حلاقة دقن', en: 'Beard Trim', price: '25' },
        { ar: 'حلاقة شعر VIP', en: 'VIP Haircut', price: '50' },
        { ar: 'حلاقة دقن VIP', en: 'VIP Beard Trim', price: '45' },
        { ar: 'شعر + دقن', en: 'Hair + Beard', price: '60' },
        { ar: 'تحديد شمع', en: 'Wax Lining', price: '20' },
        { ar: 'غسيل شعر', en: 'Hair Wash', price: '5' },
        { ar: 'ستشوار', en: 'Blow Dry', price: '15' },
        { ar: 'حلاقة أطفال', en: 'Kids Haircut', price: '30' },
        { ar: 'صباغة شعر', en: 'Hair Dye', price: '30' },
        { ar: 'صباغة دقن', en: 'Beard Dye', price: '15' },
        { ar: 'تنظيف بشرة', en: 'Skin Cleansing', price: '30' },
        { ar: 'تجهيز عرسان', en: 'Groom Package', price: '350' }
      ]
    },
    care: {
      label: { ar: 'العناية والتجميل', en: 'Care & Beauty' },
      services: [
        { ar: 'بديكير أرجل', en: 'Pedicure', price: '50' },
        { ar: 'بديكير أيادي', en: 'Manicure', price: '50' },
        { ar: 'بروتين', en: 'Protein Treatment', price: '200' }
      ]
    }
  };
  ...
  // Snapchat float → snapchat flow
  var scFloat = document.getElementById('snapchatFloat');
  if (scFloat) scFloat.addEventListener('click', function(e) {
    e.preventDefault();
  ...
  function resetChatToCategories() {
    ...
    var platformLabel = selectedPlatform === 'tiktok'
      ...
      : selectedPlatform === 'snapchat'
        ? (currentLang === 'ar' ? '\uD83D\uDC7B \u0633\u0646\u0627\u0628 \u0634\u0627\u062A' : '\uD83D\uDC7B Snapchat')
  ...
  var ICON_SNAPCHAT = '<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#111"><path d="M12.006 1.999c2.518 0 4.591.918 5.785 2.66.86 1.27 1.027 2.91.957 4.296a.46.46 0 00.22.41c.21.137.59.295 1.04.295.34 0 .68-.077.99-.2a.62.62 0 01.24-.05c.3 0 .58.18.69.46.13.33-.03.7-.36.86-.06.03-.85.42-1.02 1.2-.08.36.03.74.32 1.13.4.54 1.07.87 1.74 1.2.27.13.43.4.42.69-.02.42-.45.7-.83.85-.62.24-1.46.32-1.74.43-.08.16-.13.51-.21.78-.13.46-.59.65-1.16.65-.18 0-.37-.02-.58-.06a3.9 3.9 0 00-.78-.09c-.46 0-.81.16-1.18.34-.74.36-1.58.78-2.97.78h-.07c-1.39 0-2.23-.42-2.97-.78-.37-.18-.72-.34-1.18-.34-.27 0-.52.04-.78.09-.21.04-.4.06-.58.06-.57 0-1.03-.19-1.16-.65-.08-.27-.13-.62-.21-.78-.28-.11-1.12-.19-1.74-.43-.38-.15-.81-.43-.83-.85-.01-.29.15-.56.42-.69.67-.33 1.34-.66 1.74-1.2.29-.39.4-.77.32-1.13-.17-.78-.96-1.17-1.02-1.2-.33-.16-.49-.53-.36-.86.11-.28.39-.46.69-.46a.62.62 0 01.24.05c.31.123.65.2.99.2.39 0 .73-.13.95-.25l.1-.06a.46.46 0 00.22-.41c-.07-1.39.1-3.02.96-4.3 1.2-1.74 3.27-2.66 5.79-2.66z"/></svg>';
  ...
  function setChatHeaderPlatform(platform) {
    ...
    headerEl.classList.remove('platform-whatsapp', 'platform-tiktok', 'platform-snapchat');
    if (platform === 'whatsapp') {
      ...
      headerEl.classList.add('platform-snapchat');
      avatarEl.innerHTML = ICON_SNAPCHAT;
    } else {
  ...
  function openPaymentModal() {
    ...
    [payStep1, payStepDigital, payStepSuccess].forEach(function(s){ if(s) s.style.display='none'; });
  ...
  var payBackDigitalBtn = document.getElementById('payBackDigital');
  if(payBackDigitalBtn) payBackDigitalBtn.addEventListener('click', function() {
    payStepDigital.style.display = 'none';
